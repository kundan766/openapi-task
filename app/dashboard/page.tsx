...
function Page() {
  ...
  useEffect(() => {
    ...
    // const ctx = chartRef.current!.getContext('2d') as CanvasRenderingContext2D; // Non-null assertion
     if (ctx) {
    
    chartRef.current = new Chart(  ctx as unknown as CanvasRenderingContext2D, {
      type: 'bar',
      data: {
        ...
        <div className="flex space-x-80 p-10 -mt-10 ">
          ...
          {isAddingProfile && (
            <div className="fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50">
              ...
              {/* /* <ProfileCard onClose={handleClose} onSubmit={handleSubmit} /> */}
            </div>
          )}
